<div class="card-header text-center bg-yellow text-white">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-warning" role="alert">
            <center>
                <dl style="font-size:1.1rem;">
                    <dt>คุณอยู่กลุ่มเสี่ยงต่ำ ติดต่อ ร.พ.ใกล้บ้านหากมีอาการผิดปกติหรือแย่ลง ได้แก่ ไข้สูง หอบ เหนื่อย ไม่ได้กลิ่น ลิ้นไม่รับรส</dt>
                </dl>
            </center>
        </div>
    </div>