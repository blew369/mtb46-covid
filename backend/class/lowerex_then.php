...
$condb = new DB_con();
$strExcelFileName="RiskyLowGroup.xls";
...
if($_POST['datef'] != '' && $_POST['datel'] != '' ){
    ...
    $export = $condb->Getlowerex($datef, $datel);
}else{
    header("location: ../pages/lowerex");
}
?>
...
<body>
<center><h2>รายงานกลุ่มเสี่ยงต่ำ</h2></center>
<?php $date = date("d-m-Y");?>
<br>
...
?>
<?php
    if($pro=='0' and $tmp=='1' and $sym=='1' and $abroad=='0' and $ptcf=='0' and $pttime=='0' and $ptnear=='0'){
?>
<tr>
...
<td align="center" valign="middle"><?php echo $row['ptncheck'];?></td>
<td bgcolor="#FFFF00" align="center" valign="middle">เสี่ยงต่ำ</td>
</tr>
<?php
