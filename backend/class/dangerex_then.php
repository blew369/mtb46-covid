...
$condb = new DB_con();
$strExcelFileName="covid-RiskyGroup-export.xls";
...
if($_POST['datef'] != '' && $_POST['datel'] != '' ){
    ...
    $export = $condb->Getdangerex($datef, $datel);
}else{
    header("location: ../pages/dangerex");
}
...
<body>
<center><h2>รายงานความเสี่ยงสูง(อ้างอิงตามผู้ที่มีกิจกรรมเสี่ยงต่อการติดโควิด4กิจกรรม)</h2></center>
<?php $date = date("d-m-Y");?>
<br>
...
<td width="250" align="center" valign="middle" ><strong>สถานที่อื่น ๆ </strong></td>
...
?>
<?php
    if($ab=='1' or $pt=='1' or $pi=='1' or $pn=='1'){
?>
<tr>
...
<td bgcolor="red" align="center" valign="middle">เสี่ยงสูงสุด</td>
</tr>
<?php
}
}
