                ...
                <div class="container col-lg-8 col-md-12 col-xs-auto">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Export-กลุ่มทั้งหมด-ตามวันที่</h6>
                        </div>
                        <div class="card-body">
                            <form name="reportdate" method="post" action="../class/allex_then.php" target="_blank">
                                <div class="row">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-5">
