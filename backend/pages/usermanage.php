                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ข้อมูลและสถาะผู้ดูแล</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="mb-3" align="left">
                                    <button onclick="document.getElementById('loginid').value = ''" type="button" name="add" id="add" data-toggle="modal" class="btn btn-success" data-target="#addModal"><i class="fas fa-plus-circle"></i> เพิ่มผู้ดูแล</button>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width="10%"><button type="button" name="edit" value="edit" class="btn btn-warning btn-sm edit_data" id="<?php echo $row['loginid']; ?>"><i class="fas fa-edit"></i> แก้ไข</button></td>
                                                <td width="10%"><button type="button" name="delete" value="delete" class="btn btn-danger btn-sm delete_data" id="<?php echo $row['loginid']; ?>"><i class="fas fa-window-close"></i> ลบ</button></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                        ...
                        <div class="modal-body">
                            <form method="post" id="insert_form">
                                ...
                                <div class="form-group col-mb-3-4">
                                    <label for="tirename" class="form-label">สิทธิ์ผู้ใช้</label>
                                    <select class="form-control form-control-sm" id="role" name="role" class="selectpicker" required>
                                        <option value="0">เลือก</option>
                                        <?php
                                        $sql = $condb->fetchrole();
                                        while ($row = $sql->fetch_assoc()) { ?>
                                            <option value="<?= $row['role']; ?>"><?php echo $row['role']; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click','.delete_data',function(){
            $('.delete_data').click(function() {
                ...
                var status = confirm("คุณต้องการลบสมาชิกใช่หรือไม่?");
                if (status) {
                    $.ajax({
